    ...
    initObjects(){
        for(let i = 0; i < this.rows; i++){
            for(let j = 0; j < this.cols; j++){
                ...
                let nPetals = Math.floor(Math.random() * 9 + 8);
                let petalColor = [Math.random(), Math.random(), Math.random(), 1];
                let heartRadius = Math.random() / 2 + 0.8;
                ...
                let stemColor = [Math.random(), Math.random(), Math.random(), 1]; // [Math.random()* (0.4 - 0.1) + 0.1, Math.random() * (0.7 - 0.3) + 0.4, Math.random() * (0.3 - 0.1) + 0.1, 1];

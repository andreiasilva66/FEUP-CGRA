...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.myPrism = new MyPrism (this, 8,10);
    ...
    initMaterials() {
        ...
        this.woodMaterial.setAmbient(0.87, 0.72, 0.53, 1.0);
        this.woodMaterial.setDiffuse(0.87, 0.72, 0.53, 1.0);
        this.woodMaterial.setSpecular(0.87, 0.72, 0.53, 0.01);
